...
<br>
<br>
<a href= "/fight">Whip Your Shoes Off Him!</a>
    ...
    <head>
        ...
        <body>
         ...
         <source src="http://ccmixter.org/content/cyba/cyba_-_new_circle.mp3">
            ...
            <h1 style="font-family: 'Abril Fatface', cursive">He wont hurt you twice!</h1>
            <div class="container" style="font1">
                <div class="row">
                    <div class="col-6">
                        <label class="font1">
                            <p>
						You walk up to the stranger and exclaim "Hey man, you poisoned me
						and stole my shoes!! Not cool, broheim!" The stranger then reveals
						himself as Kyle the TA and proceeds to respond with kindness in
						his voice "Hey, I am so sorry I got carried away back there. Let
						me get you another drink - poison free this time I promise." As
						you turn toward the bar, you feel a sharp pain in your side. Kyle
						has stabbed you and you lose 5 additional points of health! Angry,
						you begin to swing wildly at Kyle and a battle ensues.</p>
						 <br>
					
                            <a href="/fight">
                                <button type="submit" class="btn btn-primary btn-lg">Whip Your Shoes Off Him!</button>
                            </a>
                        </label>
                    </div>
                    <div class="col-5">
