...
public class DungeonMaster {
	...
	public void story() {
		...
		String drink = "",decline= "",fight="",yell="",craft="",deeper="",snarky="",sock="",refuse="",insist="",love = "";
		...
		if(drink.equalsIgnoreCase("drink")) {
			...
			+ "\n 2.  Go DEEPER into the woods and just accept the fact that no one will believe you that a stranger took your shoes so that this is now your home.");
				...
				System.out.println("The spider sick of everyone always treating him with hostility lunges at you screaming “I’m sick of it lets fight!");
			...
			if(refuse.equalsIgnoreCase("refuse") || insist.equalsIgnoreCase("insist")) {
				...
				System.out.println("The Knight draws his sword and cuts you in half, you try to love him to death, but alas your heart is not as powerful as a steel sword.");
			}
			scnr.close();
		}
	}
