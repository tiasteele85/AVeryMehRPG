...
public class Woods {
	...
	public String CraftShoe() {
		String craftShoe = "You try to create a make-shift pair of shoes but fail and feel your father looking down on you disappointed because he was a cobbler and tried to teach you several times. "
	...
	public String Deeper() {
		String deeper = "As you head further into the woods you are confronted by a giant spider and realize that peace may not be in his nature. "
				+ "\nThe spider looks at you and exclaims “hey bro, quick question… where are your shoes?”"
				+ "******************************************************"
				+ "Do you: 1.Respond with a snarky comment “wouldn’t you like to know Spider-boy”"
